...
| [#20 `feat: partition monitoring state by provider surface`](https://github.com/alxbra/agent-status-tiles/pull/20) | Live Codex slice 1: schema v2 surface partitions, v1 record migration, independent atomic Connect/Disconnect | 1 completed CLI pass; 1 valid test finding fixed | 2 | 201 unit tests, 46 E2E tests, format/lint/type/build checks; [CI run 35086998134](https://github.com/alxbra/agent-status-tiles/actions/runs/35086998134) | Pending squash merge; record verified SHA in the next staging-based PR. |
