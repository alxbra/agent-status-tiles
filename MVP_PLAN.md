...
by unit tests and a native Electron E2E. The Settings row stays unavailable
until the connect slice wires installation and health; live Desktop and
terminal validation remains pending.
