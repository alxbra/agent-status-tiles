...
rollout replay, and native coordinator wiring. This slice adds the Desktop
Settings Connect/Disconnect control; independent CLI monitoring follows.
...
| Desktop Settings Connect/Disconnect (this PR) | Live Codex slice 4: separate Desktop/CLI/Claude rows, validated native connection IPC, confirmed surface-local history removal, and lost-reader coverage | Pending review | Pending | 237 unit tests; local 31 headless browser E2E pass, 18 native Electron E2E intentionally skipped to protect focus; focused native Desktop/lost-reader tests passed before focus safeguard; full native suite and CI pending | Pending squash merge; record verified SHA in the next staging-based PR. |
